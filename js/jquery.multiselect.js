...
(function(d) {
    var k = 0;
    d.widget("ech.multiselect", {options: {header: !0, height: 175, minWidth: 225, classes: "", checkAllText: "Sel. Todos", uncheckAllText: "Ninguno", noneSelectedText: " --Seleccione--", selectedText: "# Seleccionados", selectedList: 0, show: null, hide: null, autoOpen: !1, multiple: !0, position: {}}, _create: function() {
            ...
            b.find("option").each(function(b) {
                d(this);
                var a = this.parentNode, f = this.innerHTML, h = this.title, k = this.value, b = "ui-multiselect-" + (this.id || i + "-option-" + b), l = this.disabled, n = '', m = ["ui-corner-all"], o = (l ? "ui-multiselect-disabled " : " ") + this.className, j;
